...
<body class="min-h-screen flex flex-col items-center justify-center relative overflow-y-auto px-6 py-12">
    ...
    <div class="z-20 max-w-4xl text-center space-y-12 relative">
        ...
        <div class="pt-20 fade-in delay-btn pb-10">
            ...
            {{-- Recommendations --}}
            <div class="mt-12 text-neutral-400 text-xs md:text-sm font-light tracking-wider space-y-2 opacity-80">
                <p class="flex items-center justify-center gap-2">
                    <span class="inline-block w-1 h-1 bg-neutral-500 rounded-full"></span>
                    แนะนำให้กด <span class="border border-neutral-600 px-1 rounded text-neutral-300">F11</span> เพื่อประสบการณ์เต็มจอ (Full Screen)
                </p>
                <p class="flex items-center justify-center gap-2">
                    <span class="inline-block w-1 h-1 bg-neutral-500 rounded-full"></span>
